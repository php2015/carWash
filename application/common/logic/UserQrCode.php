...
use app\common\model\Seller as SellerModel;//商家模型
...
class UserQrCode extends Base
{
    ...
    public function __construct()
    {
        ...
        $this->sellerModel = new  SellerModel();//商家模型
    ...
    {
        return $this->sellerModel->getBizInfo($params);
    }
     ...
     * @throws \think\exception\DbException
     */
    public function isOwnCsCard($params)
    {
        $cardType = 2;
        return $this->userCardModel->isOwnCard($params,$cardType);
    }
     ...
     * @throws \think\exception\DbException
     */
    public function isOwnQeCard($params)
    {
        $cardType = 1;
        return $this->userCardModel->isOwnCard($params,$cardType);
    }
    ...
    {
        return $this->userCardModel->getSettlementCard($params);
    }
}